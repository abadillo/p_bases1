TABLE lugar;                       -- #LISTO   T: 1580 (1520 EMP, 984 D ( 335P, 59T ,590 C ))  
...
/* EMPLEADOS */
TABLE empleado;                    -- #LISTO   T: 590   (531 update)
...
Y PERSONAS CONTACTO*/
TABLE usuario;                     -- #1180    T: 590 C, 590 E
TABLE proveedor;                   -- #335     T: 335 (1 POR MUNICIPIO)
...
TABLE compra;                      -- #LISTO   T: 413 (295 WEB / 118 FISICAS)  5 WEB, 2 FISICA POR TIENDA       ))))
TABLE metodo_pago_compra;          -- #        T:       FALTAN ASIGNAR PUNTOS A CLEINTES Y RESTAR DE INVENTARIO .. HACER ESO CON UPDATE
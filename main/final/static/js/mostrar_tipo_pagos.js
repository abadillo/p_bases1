...
$(document).ready(function(){
    ...
    $('#tabla_datatable').DataTable({
        ...
        columns:[
            { data:      "tp_codigo" ,        title: "CODIGO"},
            { data:      "tp_descripcion" ,   title: "NOMBRE"},           
        ]
    ...
    $('#boton_añadir').click( function () {
        ...
        window.location.href =  "/registro/tipo_pago"		
    ...
    $('#boton_modificar').click( function () {
        ...
        if (sel){
            ...
            var id = sel['tp_codigo'];
            window.location.href =  '/tipo_pago/'+id;	

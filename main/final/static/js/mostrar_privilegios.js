...
$(document).ready(function(){
    ...
    $('#tabla_datatable').DataTable({
        ...
        columns:[
            { data:      "pv_codigo" ,        title: "CODIGO"},
            { data:      "pv_descripcion" ,        title: "NOMBRE"},           
        ]
    ...
    $('#boton_añadir').click( function () {
        ...
        window.location.href =  "/registro/privilegio"		
    ...
    $('#boton_modificar').click( function () {
        ...
        if (sel){
            ...
            var id = sel['pv_codigo'];
            window.location.href =  '/privilegio/'+id;	
